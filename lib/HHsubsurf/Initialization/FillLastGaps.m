function data_out = FillLastGaps(data_out,c)
    VarNames = {'AirPressurehPa' 'AirTemperatureC' 'AirTemperature1C' 'AirTemperature1C' ...
        'RelativeHumidity' 'RelativeHumidity1' 'RelativeHumidity2' ...
        'WindSpeedms' 'WindSpeed1ms' 'WindSpeed2ms' ...
        ...
        'HeightHumiditym' 'HeightWindSpeed1m' 'HeightTemperature1m', ...
        'HeightHumidity1m' 'HeightWindSpeed2m' 'HeightTemperature2m', ...
        'HeightHumidity2m'};
